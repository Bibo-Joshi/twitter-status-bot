...
class UserData:  # pylint: disable=R0902
    ...
    Attributes:
        ...
        temp_file_ids: Temporarily saved file ids of stickers generated by the user.
        store_stickers: Whether or not this users wants to store stickers. Defaults to :obj:`True`.
        inline_query_thread: Optional. A :class:`threading.Thread` which answers the current inline
            query.
        inline_query_event: Optional. An :class:`threading.Event`. Setting this event will cause
            :attr:`inline_query_thread` to terminate.
    ...
    def __init__(  # pylint: disable=R0913
        ...
        self.inline_query_thread: Optional[Thread] = None
    ...
    # We override __reduce__ to amend for the unpickable thread & event
    def __reduce__(
        self,
